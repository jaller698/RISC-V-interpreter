object CheckerRules {
    sealed trait Piece { def isWhite: Boolean; def isBlack: Boolean; def isKing: Boolean }
    case object Empty extends Piece { val isWhite = false; val isBlack = false; val isKing = false }
    case object White extends Piece { val isWhite = true; val isBlack = false; val isKing = false }
    case object WhiteKing extends Piece { val isWhite = true; val isBlack = false; val isKing = true }
    case object Black extends Piece { val isWhite = false; val isBlack = true; val isKing = false }
    case object BlackKing extends Piece { val isWhite = false; val isBlack = true; val isKing = true }
